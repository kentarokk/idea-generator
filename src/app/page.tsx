  ...
  return (
    <div>
      <nav className="flex justify-between items-center py-2 mx-4 md:mx-[10%] mt-2 border-b-2">
        ...
        <button
          onClick={signIn}
          className="px-4 py-2 mb-2 md:mx-4 transition-all duration-500 bg-gray-400 rounded-md text-white text-xl hover:bg-gray-300"
        >
          sign in
        </button>
      </nav>
      <main className="flex min-h-screen flex-col items-center justify-between px-10">
        <div className="flex justify-center items-center flex-col gap-3">
          ...
          >
            <button
              onClick={clickBtn}
              className="mt-12 p-6 transition-all duration-500 bg-yellow-500 rounded-md text-white text-2xl hover:bg-yellow-400"
            >
              Generate Idea
            </button>
          </motion.div>
            ...
            {isShow && (
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-24 items-center">
                    ...
                    <div className="flex">
                      <input
                        ...
                        className="bg-slate-200 w-[80%] md:w-[400px] px-2 py-2 outline-none"
                      />
                      <button
                        onClick={createIdea}
                        className="x-[20%] bg-slate-400 text-white py-2 px-4 rounded-md"
                      >
                        Create
                      </button>
                    </div>
                  ...
                  {ideaList.map((idea) => {
                    return (
                      <div className="w-full md:w-[440px] mt-4 p-4 border border-yellow-500 rounded-md flex flex-col gap-4 justify-center items-center">
